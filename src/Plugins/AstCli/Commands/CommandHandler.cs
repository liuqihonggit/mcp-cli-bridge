...
#pragma warning restore MCP001
        ...
        var result = await AstEngine.QuerySymbolAsync(provider, request.ProjectPath, request.SymbolName, request.Scope);
...
#pragma warning restore MCP001
        ...
        var result = await AstEngine.FindReferencesAsync(provider, request.ProjectPath, request.SymbolName);
...
#pragma warning restore MCP001
        ...
        var result = await AstEngine.RenameSymbolAsync(provider, request.ProjectPath, request.SymbolName, request.NewName);
...
#pragma warning restore MCP001
        ...
        var result = await AstEngine.ReplaceSymbolAsync(provider, request.ProjectPath, request.SymbolName, request.NewName);
    ...
    private static async Task<OperationResult<JsonElement>> GetSymbolInfoAsync(AstCliRequest request)
    {
        ...
        var result = await AstEngine.GetSymbolInfoAsync(provider, projectPath, request.FilePath, request.LineNumber, request.ColumnNumber);
...
#pragma warning restore MCP001
        ...
        var result = await AstEngine.WorkspaceOverviewAsync(provider, request.ProjectPath);
...
#pragma warning restore MCP001
        ...
        var result = await AstEngine.FileContextAsync(provider, request.ProjectPath, request.FilePath);
...
#pragma warning restore MCP001
        ...
        var result = await AstEngine.DiagnosticsAsync(provider, request.ProjectPath, request.FilePath);
...
#pragma warning restore MCP001
        ...
        var result = await AstEngine.SymbolOutlineAsync(provider, request.FilePath);
...
#pragma warning restore MCP001
        ...
        var result = await StringLiteralEngine.QueryAsync(provider, request.ProjectPath, request.FilePath, request.Prefix, request.Filter);
...
#pragma warning restore MCP001
        ...
        var result = await StringLiteralEngine.InsertAsync(
            provider, request.ProjectPath, request.FilePath, request.InsertText, 0, "prefix", request.Filter, request.DryRun);
...
#pragma warning restore MCP001
        ...
        var result = await StringLiteralEngine.InsertAsync(
            provider, request.ProjectPath, request.FilePath, request.InsertText, int.MaxValue, "suffix", request.Filter, request.DryRun);
        return Ok(result, result.Message, AstCliJsonContext.Default.StringInsertResultDto);
    }
...
#pragma warning restore MCP001
        ...
        var result = await StringLiteralEngine.InsertAsync(
            provider, request.ProjectPath, request.FilePath, request.InsertText, request.Position, "insert", request.Filter, request.DryRun);
        return Ok(result, result.Message, AstCliJsonContext.Default.StringInsertResultDto);
    }
...
#pragma warning restore MCP001
        ...
        var result = await StringLiteralEngine.ReplaceAsync(
            provider, request.ProjectPath, request.FilePath, request.Pattern, request.Replacement, request.UseRegex, request.Filter, request.DryRun);
    ...
    private static (ILanguageProvider Provider, OperationResult<JsonElement>? Error) ResolveProvider(string? language)
    {
        ...
        return (provider, new OperationResult<JsonElement>
        {
            Success = false,
